#Hayo..mau apa.. Recode ya... Ok gapp

[]==================================[]
[]             SpamCall  	    [] WR.py
[]==================================[]
[] => Author   : THE IMMORTAL HACKER       []
[] => Nama     : WR.py		    []
[] => Youtube  : - 
[] => github   : - github.com/THEIMMORTALHACKER []
[]==================================[]
[] do not use it wrong jangan salah gunakan	    []
[]==================================[]
...
echo "\n";
echo "[][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][]\n";
echo "[!] Contoh>>62/08 [ contoh 62********* / 08*********** ] [!]\n";
echo "[][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][]\n";
echo " \n";
echo "\n";
echo " \n";
